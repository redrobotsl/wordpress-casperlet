 ...
 * 
 * RRCLET->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Rental_Directory_For_Casperlet_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		RRCLET
 * @subpackage	Classes/Rental_Directory_For_Casperlet_Settings
 * @author		Nolan Perry
 * @since		1.0.0
 */
class Rental_Directory_For_Casperlet_Settings{
	...
	/**
	 * Our Rental_Directory_For_Casperlet_Settings constructor 
	...
	public function get_plugin_name(){
		return apply_filters( 'RRCLET/settings/get_plugin_name', $this->plugin_name );
	}
}
